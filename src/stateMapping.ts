...
export const STATE_MAPPING: Record<string, StateDefinition> = {
	...
	temperature_heat_source_in: {
		folder: "Informationen.Temperaturen",
		name: "Wärmequelle-Eingang-Temperatur",
		role: "value.temperature",
		type: "number",
		unit: "°C",
	},
	...
	HDin: {
		folder: "inputs",
		name: "Eingang Hochdruckwächter HD",
		role: "value",
		type: "number",
	},
	MOTin: {
	...
	NDin: {
		folder: "inputs",
		name: "Eingang Niederdruckwächter ND",
		role: "value",
		type: "number",
	},
	NDin_pressure: {
	...
	PEXin: {
		folder: "inputs",
		name: "Eingang Externer Druckwächter PEX",
		role: "value",
		type: "number",
	},
	SWTin: {
	...
	BUPout: {
		folder: "outputs",
		name: "Ausgang Warmwasser-Umwälzpumpe BUP",
		role: "value",
		type: "number",
	},
	HUPout: {
		folder: "outputs",
		name: "Ausgang Heizungsumwälzpumpe HUP",
		role: "value",
		type: "number",
	},
	MA1out: {
	...
	ZUPout: {
		folder: "outputs",
		name: "Ausgang Zusatzumwälzpumpe ZUP",
		role: "value",
		type: "number",
	},
	ZW1out: {
		folder: "outputs",
		name: "Ausgang Zweiter Wärmeerzeuger 1 ZW1",
		role: "value",
		type: "number",
	},
	ZW2SSTout: {
		folder: "outputs",
		name: "Ausgang ZW2 / Störungsmeldung",
		role: "value",
		type: "number",
	},
	ZW3SSTout: {
		folder: "outputs",
		name: "Ausgang ZW3 / Sammelstörung",
		role: "value",
		type: "number",
	},
	FP2out: {
	...
	Timer_EinschVerz: {
		folder: "timers",
		name: "Einschaltverzögerung Timer",
		role: "value",
		type: "number",
		unit: "s",
	},
